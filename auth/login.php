	...
	<div class="col-md-6 col-md-offset-3 well">
		...
		<form class="form" name="form">
			<div class="col-xs-8 col-xs-offset-2">
				...
				<input type="text" class="form-control" required placeholder="Введите Логин" name="login" />
				</div>
			</div>
			<div class="col-xs-8 col-xs-offset-2">
				<div class="form-group">
				<input type="password" class="form-control" required placeholder="Введите Пароль" name="password" />
				</div>
			</div>
			<div class="text-center col-xs-12">
				<input type="submit" class="btn btn-default" value="Вход" />
				<a href="/polling" class="btn btn-default anonym-login">Анонимный вход</a>
			</div>
		</form>
	</div>
	<div class="col-md-6 col-md-offset-3 info">
		<div class="abbr">ВПК</div>
		<div class="copyright">&copy; Волчиха 2019</div>
	</div>
</div>
</body>
</html>